...
function KeyMusicCard({ songName, songArtist, songPhoto, spotifyLink, ytmusicLink }) {
    return (
        <div className='container flex justify-center mt-4'>
            <div className='flex flex-row items-center bg-blue-50 px-4 py-3 rounded-[28px] w-[430px]'>
                ...
                <div className='flex flex-col items-center ml-2'>
                    <p style={{color:"black"}} className="font-sansi font-sansi font-black italic text-sm tracking-wider mr-auto">{songName}</p>
